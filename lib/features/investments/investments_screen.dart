...
final portfolioAnalysisProvider = FutureProvider.family<String, List<Asset>>((
  ...
  try {
    ...
    if (e.message.contains('API key')) {
      return 'AI analizi için lütfen Ayarlar ekranından Gemini API key ekleyin.';
    }
    return 'Portföy analizi yapılamadı: ${e.message}';
  } catch (_) {
    return 'ALTERA Ajanı şu an portföyü analiz edemiyor. Lütfen tekrar deneyin.';
  }
});
...
class _AiAgentCardState extends ConsumerState<_AiAgentCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final usdRate =
        ref.watch(yahooFinanceProvider('TRY=X')).valueOrNull?['price']
            as double? ??
        1.0;
                      ...
                      : Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color: gainColor.withOpacity(0.8),
                              fontSize: 13,
                              fontWeight: FontWeight.w600,
                            ),
                          ),
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color:
                        hasLimit
                            ? const Color(0xFF8B95A5).withOpacity(0.5)
                            : const Color(0xFF8B95A5),
                    fontSize: 14,
